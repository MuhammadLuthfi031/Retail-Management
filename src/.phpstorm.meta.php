...
'profile.destroy','kasir.pos','kasir.produk','gudang.kategori.index','gudang.kategori.store',
'gudang.kategori.update','gudang.kategori.destroy','gudang.produk.index','gudang.produk.store','gudang.produk.update',
'gudang.produk.destroy','gudang.stok.index','gudang.pembelian.index','gudang.pembelian.show','gudang.pembelian.store',
'admin.dashboard','admin.users','admin.laporan','admin.supplier.index','admin.supplier.store',
'admin.supplier.update','admin.supplier.destroy','admin.pembelian.index','admin.pembelian.store','admin.pembelian.show',
'admin.pembelian.update','admin.pembelian.destroy','admin.pembelian.mark-ordered','admin.pembelian.cancel','admin.pembelian.payment-status',
...
'admin.Dashboard','admin.Laporan','admin.Users','admin.pembelian._form','admin.pembelian._item-row',
'admin.pembelian.index','admin.pembelian.show','admin.supplier._fields','admin.supplier.index','auth.confirm-password',
'auth.forgot-password','auth.login','auth.register','auth.reset-password','auth.verify-email',
'components.alert','components.application-logo','components.auth-session-status','components.barcode-input','components.barcode-scan-shared',
'components.danger-button','components.dropdown','components.dropdown-link','components.icon','components.input-error',
'components.input-label','components.modal','components.modal.modal','components.modal.script','components.modal.sheet',
'components.nav-link','components.primary-button','components.responsive-nav-link','components.secondary-button','components.sidebar-link',
'components.text-input','dashboard','gudang.kategori.index','gudang.pembelian.index','gudang.pembelian.show',
'gudang.produk._form','gudang.produk._unit-row','gudang.produk.index','kasir.Pos','kasir.Produk',
'layouts.app','layouts.guest','layouts.navigation','layouts.partials.bottom-nav','layouts.partials.mobile-topbar',
'layouts.partials.sidebar','layouts.sidebar','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
